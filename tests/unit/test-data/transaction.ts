...
import { TransactionListResponse } from '@/models/transaction'
  ...
  items: [
    {
      ...
      createdOn: '2023-01-24T14:00:00', // The api does not provide the timezone information date display set it to UTC
      ...
      refundDate: '2023-01-25T14:00:00'
    },
    {
